    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,
                        "/cinema-halls/*",
                        "/movies/*",
                        "/movie-sessions/available/*").hasAnyRole(ADMIN_ROLE, USER_ROLE)
                .antMatchers(HttpMethod.POST,
                        "/cinema-halls/*",
                        "/movies/*",
                        "/movie-sessions/*").hasRole(ADMIN_ROLE)
                .antMatchers(HttpMethod.GET,
                        "/users/by-email/*").hasRole(ADMIN_ROLE)
                ...
                .antMatchers(HttpMethod.POST,
                        "/orders/complete/*").hasRole(USER_ROLE)
                .antMatchers(HttpMethod.PUT,
                        "/shopping-carts/movie-sessions/*").hasRole(USER_ROLE)
