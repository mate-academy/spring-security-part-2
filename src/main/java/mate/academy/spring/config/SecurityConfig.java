...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth
                ...
                .passwordEncoder(passwordEncoder)
                .withUser("1@123").password(passwordEncoder.encode("123")).roles("USER");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,"/cinema-halls").hasAnyRole("ADMIN", "ROLE")
                .antMatchers(HttpMethod.POST,"/cinema-halls").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET,"/movies").hasAnyRole("ADMIN", "ROLE")
                .antMatchers(HttpMethod.POST,"/movies").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET,"/movie-sessions/available").hasAnyRole("ADMIN", "ROLE")
