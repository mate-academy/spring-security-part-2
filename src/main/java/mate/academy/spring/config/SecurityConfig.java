...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/cinema-halls/**").hasAnyRole(ADMIN_ROLE_NAME,USER_ROLE_NAME)
                ...
                .antMatchers(HttpMethod.GET, "/orders/**").hasAnyRole(ADMIN_ROLE_NAME,USER_ROLE_NAME)
